...
public class FPUAddTest {
    ...
    public void fpuAddTest1() {
        src = new DataType("10000000010000000000000000000000");//10000000001111111111111111111111;10000000010000000000000000000001
        dest = new DataType("10000000010000000000000000000000");
        result = fpu.add(src, dest);
        float deNorm2 = Float.parseFloat(Transformer.binaryToFloat("10000000010000000000000000000000"));
        float deNorm3 = Float.parseFloat(Transformer.binaryToFloat("10000000010000000000000000000000"));
        assertEquals(Transformer.intToBinary(Integer.toString(Float.floatToIntBits(deNorm3+deNorm2))), result.toString());
    }
