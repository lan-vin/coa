...
public class TransformerTest {
    ...
    public void intToBinaryTest1() {
        assertEquals("00000000000000000000000000000010", Transformer.intToBinary("-2147483648"));
    }
    ...
    public void floatToBinaryTest1() {
        assertEquals("01011111100000000000000000000000", Transformer.floatToBinary(String.valueOf(Math.pow(2, 64))));
